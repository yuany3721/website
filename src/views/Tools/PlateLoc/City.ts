...
export const cqs = (car: string[]): string[] => {
    ...
    switch (tag) {
        ...
        case 'C':
            return [
                '永川车辆管理所：永川市、江津市、合川市、潼南县、铜梁县、壁山县、大足县、綦江县、荣昌县',
            ]
        case 'F':
            return [
                '万州车辆管理所：万州区、梁平县、城口县、巫山县、巫溪县、忠县、开县、奉节县、云阳县',
            ]
        case 'G':
            return ['涪陵车辆管理所：涪陵区、南川市、垫江县、丰都县、武隆县']
        case 'H':
            return [
                '黔江车辆管理所：黔江区、石柱土家族自治县、秀山土家族苗族自治县、酉阳土家族苗族自治县、彭水苗族土家族自治县',
            ]
    }
    return ['']
}
...
export const hainan = (car: string[]): string[] => {
    ...
    switch (tag) {
        ...
        case 'C':
            return [
                '琼北车辆管理所：琼山市（已并入海口市）、儋州市、琼海市、万宁市、文昌市、澄迈县、屯昌县、定安县、临高县',
            ]
        case 'D':
            return [
                '琼南车辆管理所：五指山市、东方市、白沙黎族自治县、昌江黎族自治县、陵水黎族自治县、乐东黎族自治县、保亭黎族苗族自治县、琼中黎族苗族自治县',
            ]
        case 'E':
            return ['洋浦开发区']
    }
